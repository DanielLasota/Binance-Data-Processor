...
class DataQualityChecker:
    ...
    def _get_full_difference_depth_dataframe_report(df: pd.DataFrame, asset_parameters: AssetParameters) -> DataQualityReport:
        ...
        is_timestamp_of_receive_not_less_than_event_time_by_1_ms_and_not_greater_by_3000_ms = icc.is_timestamp_of_column_a_not_less_than_column_b_by_x_ms_and_not_greater_by_y_ms(df['TimestampOfReceive'], df['EventTime'], x_ms=-1, y_ms=3000, epoch_time_unit=epoch_time_unit)
        report.add_test_result("TimestampOfReceive", "is_series_non_decreasing", is_series_non_decreasing)
        report.add_test_result("TimestampOfReceive", "is_series_epoch_valid", is_series_epoch_valid)
        report.add_test_result("TimestampOfReceive", "is_series_epoch_within_utc_z_day_range", is_series_epoch_within_utc_z_day_range)
        report.add_test_result("TimestampOfReceive", "is_timestamp_of_receive_not_less_than_event_time_by_1_ms_and_not_greater_by_3000_ms", is_timestamp_of_receive_not_less_than_event_time_by_1_ms_and_not_greater_by_3000_ms)
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_timestamp_of_receive_not_less_than_transaction_time_by_1_ms_and_not_greater_by_3000_ms = icc.is_timestamp_of_column_a_not_less_than_column_b_by_x_ms_and_not_greater_by_y_ms(df['TimestampOfReceive'], df['TransactionTime'], x_ms=-1, y_ms=3000, epoch_time_unit=epoch_time_unit)
            report.add_test_result("TimestampOfReceive", "is_timestamp_of_receive_not_less_than_transaction_time_by_1_ms_and_not_greater_by_3000_ms", is_timestamp_of_receive_not_less_than_transaction_time_by_1_ms_and_not_greater_by_3000_ms)
        ...
        report.add_test_result("EventTime", "is_timestamp_of_receive_not_less_than_event_time_by_1_ms_and_not_greater_by_3000_ms", is_timestamp_of_receive_not_less_than_event_time_by_1_ms_and_not_greater_by_3000_ms)
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            ...
            report.add_test_result("TransactionTime", "is_timestamp_of_receive_not_less_than_transaction_time_by_1_ms_and_not_greater_by_3000_ms", is_timestamp_of_receive_not_less_than_transaction_time_by_1_ms_and_not_greater_by_3000_ms)
    ...
    def _get_full_depth_snapshot_dataframe_report(df: pd.DataFrame, asset_parameters: AssetParameters) -> DataQualityReport:
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_timestamp_of_receive_not_less_than_message_output_time_by_1_ms_and_not_greater_by_3000_ms = icc.is_timestamp_of_column_a_not_less_than_column_b_by_x_ms_and_not_greater_by_y_ms(df['TimestampOfReceive'], df['MessageOutputTime'], x_ms=-1, y_ms=3000, epoch_time_unit=epoch_time_unit)
            ...
            report.add_test_result("TimestampOfReceive", "is_timestamp_of_receive_not_less_than_message_output_time_by_1_ms_and_not_greater_by_3000_ms", is_timestamp_of_receive_not_less_than_message_output_time_by_1_ms_and_not_greater_by_3000_ms)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_message_output_time_not_less_than_timestamp_of_request_by_3000_ms_and_not_greater_by_3000_ms = icc.is_timestamp_of_column_a_not_less_than_column_b_by_x_ms_and_not_greater_by_y_ms(timestamp_of_receive_column=df['MessageOutputTime'], event_time_column=df['TimestampOfRequest'], x_ms=-3000, y_ms=3000, epoch_time_unit=epoch_time_unit)
            ...
            report.add_test_result("TimestampOfRequest", "is_message_output_time_not_less_than_timestamp_of_request_by_3000_ms_and_not_greater_by_3000_s", is_message_output_time_not_less_than_timestamp_of_request_by_3000_ms_and_not_greater_by_3000_ms)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            ...
            report.add_test_result("MessageOutputTime", "is_timestamp_of_receive_not_less_than_message_output_time_by_1_ms_and_not_greater_by_3000_ms", is_timestamp_of_receive_not_less_than_message_output_time_by_1_ms_and_not_greater_by_3000_ms)
            report.add_test_result("MessageOutputTime", "is_message_output_time_not_less_than_timestamp_of_request_by_3000_ms_and_not_greater_by_3000_ms", is_message_output_time_not_less_than_timestamp_of_request_by_3000_ms_and_not_greater_by_3000_ms)
    ...
    def _get_full_trade_dataframe_report(df: pd.DataFrame, asset_parameters: AssetParameters) -> DataQualityReport:
        ...
        is_series_epoch_valid = icc.is_series_epoch_valid(df['TimestampOfReceive'])
        is_series_epoch_within_utc_z_day_range = icc.is_series_epoch_within_utc_z_day_range(df['TimestampOfReceive'], date=asset_parameters.date, epoch_time_unit=epoch_time_unit)
        is_timestamp_of_receive_not_less_than_event_time_by_one_ms_and_not_greater_by_3000_ms = icc.is_timestamp_of_column_a_not_less_than_column_b_by_x_ms_and_not_greater_by_y_ms(df['TimestampOfReceive'], df['EventTime'], x_ms=-1, y_ms=3000, epoch_time_unit=epoch_time_unit)
        is_timestamp_of_receive_not_less_than_transaction_time_by_one_ms_and_not_greater_by_3000_ms = icc.is_timestamp_of_column_a_not_less_than_column_b_by_x_ms_and_not_greater_by_y_ms(df['TimestampOfReceive'], df['TransactionTime'], x_ms=-1, y_ms=3000, epoch_time_unit=epoch_time_unit)
        report.add_test_result("TimestampOfReceive", "is_series_non_decreasing", is_series_non_decreasing)
        report.add_test_result("TimestampOfReceive", "is_series_epoch_valid", is_series_epoch_valid)
        report.add_test_result("TimestampOfReceive", "is_series_epoch_within_utc_z_day_range", is_series_epoch_within_utc_z_day_range)
        report.add_test_result("TimestampOfReceive", "is_timestamp_of_receive_not_less_than_event_time_by_one_ms_and_not_greater_by_3000_ms", is_timestamp_of_receive_not_less_than_event_time_by_one_ms_and_not_greater_by_3000_ms)
        report.add_test_result("TimestampOfReceive", "is_timestamp_of_receive_not_less_than_transaction_time_by_one_ms_and_not_greater_by_3000_ms", is_timestamp_of_receive_not_less_than_transaction_time_by_one_ms_and_not_greater_by_3000_ms)
        if asset_parameters.market in [Market.SPOT, Market.USD_M_FUTURES]:
        ...
        report.add_test_result("EventTime", "is_series_non_decreasing", is_series_non_decreasing)
        report.add_test_result("EventTime", "is_series_epoch_valid", is_series_epoch_valid)
        report.add_test_result("EventTime", "is_timestamp_of_receive_not_less_than_event_time_by_one_ms_and_not_greater_by_3000_ms", is_timestamp_of_receive_not_less_than_event_time_by_one_ms_and_not_greater_by_3000_ms)
        ...
        report.add_test_result("TransactionTime", "is_series_non_decreasing", is_series_non_decreasing)
        report.add_test_result("TransactionTime", "is_series_epoch_valid", is_series_epoch_valid)
        report.add_test_result("TransactionTime", "is_timestamp_of_receive_not_less_than_transaction_time_by_one_ms_and_not_greater_by_3000_ms", is_timestamp_of_receive_not_less_than_transaction_time_by_one_ms_and_not_greater_by_3000_ms)
