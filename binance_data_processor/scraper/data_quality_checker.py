...
class DataQualityChecker:
    ...
    def _get_full_depth_snapshot_dataframe_report(df: pd.DataFrame, asset_parameters: AssetParameters) -> DataQualityReport:
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            ...
            is_timestamp_of_receive_no_greater_than_message_transaction_time_by_one_s_and_no_less_by_1_ms = (IndividualColumnChecker.is_timestamp_of_column_a_no_greater_than_column_b_by_one_s_and_no_less_by_1_ms(df['TimestampOfReceive'], df['TransactionTime'], epoch_time_unit=epoch_time_unit))
            ...
            report.add_test_result("TimestampOfReceive", "is_timestamp_of_receive_no_greater_than_message_transaction_time_by_one_s_and_no_less_by_1_ms", is_timestamp_of_receive_no_greater_than_message_transaction_time_by_one_s_and_no_less_by_1_ms)
        ...
        is_first_timestamp_within_60_seconds_from_the_borders = IndividualColumnChecker.are_first_timestamp_within_n_seconds_from_the_utc_date_start(df['TimestampOfRequest'], date=asset_parameters.date, n_seconds=60, epoch_time_unit=epoch_time_unit)
        is_timestamp_of_receive_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms =  IndividualColumnChecker.is_timestamp_of_column_a_no_greater_than_column_b_by_one_s_and_no_less_by_1_ms(df['TimestampOfReceive'], df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_message_output_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_no_greater_than_column_b_by_one_s_and_no_less_by_1_ms(timestamp_of_receive_column=df['MessageOutputTime'], event_time_column=df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit)
            is_transaction_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_no_greater_than_column_b_by_one_s_and_no_less_by_1_ms(timestamp_of_receive_column=df['TransactionTime'], event_time_column=df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit)
            report.add_test_result("TimestampOfRequest", "is_message_output_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms", is_message_output_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms)
            report.add_test_result("TimestampOfRequest", "is_transaction_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms", is_transaction_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            ...
            is_timestamp_of_receive_no_greater_than_message_output_time_by_one_s_and_no_less_by_1_ms = (IndividualColumnChecker.is_timestamp_of_column_a_no_greater_than_column_b_by_one_s_and_no_less_by_1_ms(df['TimestampOfReceive'], df['MessageOutputTime'], epoch_time_unit=epoch_time_unit))
            is_message_output_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms = (IndividualColumnChecker.is_timestamp_of_column_a_no_greater_than_column_b_by_one_s_and_no_less_by_1_ms(df['MessageOutputTime'], df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit))
            ...
            report.add_test_result("MessageOutputTime", "is_message_output_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms", is_message_output_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            ...
            is_whole_series_epoch_valid = IndividualColumnChecker.is_whole_series_epoch_valid(df['TransactionTime'])
            ...
            is_timestamp_of_receive_no_greater_than_message_transaction_time_by_one_s_and_no_less_by_1_ms = (IndividualColumnChecker.is_timestamp_of_column_a_no_greater_than_column_b_by_one_s_and_no_less_by_1_ms(df['TimestampOfReceive'], df['TransactionTime'], epoch_time_unit=epoch_time_unit))
            is_message_output_time_no_greater_than_transaction_time_by_one_s_and_no_less_by_1_ms = (IndividualColumnChecker.is_timestamp_of_column_a_no_greater_than_column_b_by_one_s_and_no_less_by_1_ms(df['MessageOutputTime'], df['TransactionTime'], epoch_time_unit=epoch_time_unit))
            is_transaction_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms = (IndividualColumnChecker.is_timestamp_of_column_a_no_greater_than_column_b_by_one_s_and_no_less_by_1_ms(df['TransactionTime'], df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit))
            report.add_test_result("TransactionTime", "is_series_non_decreasing", is_series_non_decreasing)
            report.add_test_result("TransactionTime", "is_whole_series_epoch_valid", is_whole_series_epoch_valid)
            ...
            report.add_test_result("TransactionTime", "is_timestamp_of_receive_no_greater_than_message_transaction_time_by_one_s_and_no_less_by_1_ms", is_timestamp_of_receive_no_greater_than_message_transaction_time_by_one_s_and_no_less_by_1_ms)
            ...
            report.add_test_result("TransactionTime", "is_transaction_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms", is_transaction_time_no_greater_than_timestamp_of_request_by_one_s_and_no_less_by_1_ms)
    ...
    def _get_full_trade_dataframe_report(df: pd.DataFrame, asset_parameters: AssetParameters) -> DataQualityReport:
        ...
        are_price_in_range = IndividualColumnChecker.are_values_exclusively_within_specified_reasonable_range(df['Price'], 0.0, 1e9)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            ...
            are_price_values_within_reasonable_range_zero_to_1e6 = IndividualColumnChecker.are_values_exclusively_within_specified_reasonable_range(df[df['XUnknownParameter'] == 'MARKET']['Price'], 0.0, 1e6)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            ...
            are_quantity_values_within_reasonable_range_zero_to_1e9 = IndividualColumnChecker.are_values_exclusively_within_specified_reasonable_range(df[df['XUnknownParameter'] == 'MARKET']['Quantity'], 0.0, 1e9)
            report.add_test_result("Quantity", "ale_values_positive", are_values_positive)
            report.add_test_result("Quantity", "are_quantity_values_with_specified_type_of_float", are_quantity_values_with_specified_type_of_float)
            report.add_test_result("Quantity", "are_quantity_values_within_reasonable_range_zero_to_1e9", are_quantity_values_within_reasonable_range_zero_to_1e9)
