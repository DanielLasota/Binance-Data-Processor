...
class DataQualityChecker:
    ...
    def _get_full_difference_depth_dataframe_report(df: pd.DataFrame, asset_parameters: AssetParameters) -> DataQualityReport:
        ...
        is_series_non_decreasing = IndividualColumnChecker.is_series_non_decreasing(df['TimestampOfReceive'])
        is_series_epoch_valid = IndividualColumnChecker.is_series_epoch_valid(df['TimestampOfReceive'])
        is_series_epoch_within_utc_z_day_range = IndividualColumnChecker.is_series_epoch_within_utc_z_day_range(df['TimestampOfReceive'], date=asset_parameters.date, epoch_time_unit=epoch_time_unit)
        is_timestamp_of_receive_not_greater_than_event_time_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['TimestampOfReceive'], df['EventTime'], epoch_time_unit=epoch_time_unit)
        ...
        is_there_only_one_unique_expected_value_in_series = IndividualColumnChecker.is_there_only_one_unique_expected_value_in_series(df['Stream'], f"{asset_parameters.pairs[0]}@depth@100ms")
        ...
        is_there_only_one_unique_expected_value_in_series = IndividualColumnChecker.is_there_only_one_unique_expected_value_in_series(df['EventType'], "depthUpdate")
        ...
        is_series_non_decreasing = IndividualColumnChecker.is_series_non_decreasing(df['EventTime'])
        is_series_epoch_valid = IndividualColumnChecker.is_series_epoch_valid(df['EventTime'])
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_event_time_not_greater_than_transaction_time_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['EventTime'], df['TransactionTime'], epoch_time_unit=epoch_time_unit)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_series_non_decreasing = IndividualColumnChecker.is_series_non_decreasing(df['TransactionTime'])
            is_series_epoch_valid = IndividualColumnChecker.is_series_epoch_valid(df['TransactionTime'])
            is_event_time_not_greater_than_transaction_time_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['EventTime'], df['TransactionTime'], epoch_time_unit=epoch_time_unit)
        ...
        is_there_only_one_unique_expected_value_in_series = IndividualColumnChecker.is_there_only_one_unique_expected_value_in_series(df['Symbol'], asset_parameters.pairs[0].upper())
        ...
        is_series_non_decreasing = IndividualColumnChecker.is_series_non_decreasing(df['FirstUpdateId'])
        ...
        if asset_parameters.market is Market.SPOT:
            is_first_update_id_bigger_by_one_than_previous_entry_final_update_id = IndividualColumnChecker.is_first_update_id_bigger_by_one_than_previous_entry_final_update_id(df['FirstUpdateId'], df['FinalUpdateId'])
        ...
        is_series_non_decreasing = IndividualColumnChecker.is_series_non_decreasing(df['FinalUpdateId'])
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_series_non_decreasing = IndividualColumnChecker.is_series_non_decreasing(df['FinalUpdateIdInLastStream'])
            is_final_update_id_equal_to_previous_entry_final_update = IndividualColumnChecker.is_final_update_id_equal_to_previous_entry_final_update(df['FinalUpdateId'], df['FinalUpdateIdInLastStream'])
        ...
        is_series_of_zero_or_one_only = IndividualColumnChecker.is_series_of_zero_or_one_only(df['IsAsk'])
    ...
    def _get_full_depth_snapshot_dataframe_report(df: pd.DataFrame, asset_parameters: AssetParameters) -> DataQualityReport:
        ...
        is_series_epoch_valid = IndividualColumnChecker.is_series_epoch_valid(df['TimestampOfReceive'])
        is_series_epoch_within_utc_z_day_range = IndividualColumnChecker.is_series_epoch_within_utc_z_day_range(df['TimestampOfReceive'], date=asset_parameters.date, epoch_time_unit=epoch_time_unit)
        is_first_timestamp_within_60_s_from_the_utc_date_start = IndividualColumnChecker.is_first_timestamp_within_n_seconds_from_the_utc_date_start(df['TimestampOfReceive'], date=asset_parameters.date, n_seconds=60, epoch_time_unit=epoch_time_unit)
        is_timestamp_of_receive_not_greater_than_timestamp_of_request_by_one_s_and_not_less_by_1_ms =  IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['TimestampOfReceive'], df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit)
        report.add_test_result("TimestampOfReceive", "is_series_non_decreasing", is_series_non_decreasing)
        report.add_test_result("TimestampOfReceive", "is_series_epoch_valid", is_series_epoch_valid)
        report.add_test_result("TimestampOfReceive", "is_series_epoch_within_utc_z_day_range", is_series_epoch_within_utc_z_day_range)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_timestamp_of_receive_not_greater_than_message_output_time_by_one_s_and_not_less_by_1_ms = (IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['TimestampOfReceive'], df['MessageOutputTime'], epoch_time_unit=epoch_time_unit))
            is_timestamp_of_receive_not_greater_than_message_transaction_time_by_one_s_and_not_less_by_1_ms = (IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['TimestampOfReceive'], df['TransactionTime'], epoch_time_unit=epoch_time_unit))
        ...
        is_series_non_decreasing = IndividualColumnChecker.is_series_non_decreasing(df['TimestampOfRequest'])
        is_series_epoch_valid = IndividualColumnChecker.is_series_epoch_valid(df['TimestampOfRequest'])
        is_series_epoch_within_utc_z_day_range = IndividualColumnChecker.is_series_epoch_within_utc_z_day_range(df['TimestampOfRequest'], date=asset_parameters.date, epoch_time_unit=epoch_time_unit)
        is_first_timestamp_within_60_s_from_the_utc_date_start = IndividualColumnChecker.is_first_timestamp_within_n_seconds_from_the_utc_date_start(df['TimestampOfRequest'], date=asset_parameters.date, n_seconds=60, epoch_time_unit=epoch_time_unit)
        is_timestamp_of_receive_not_greater_than_timestamp_of_request_by_one_s_and_not_less_by_1_ms =  IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['TimestampOfReceive'], df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_message_output_time_not_greater_than_timestamp_of_request_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(timestamp_of_receive_column=df['MessageOutputTime'], event_time_column=df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit)
            is_transaction_time_not_greater_than_timestamp_of_request_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(timestamp_of_receive_column=df['TransactionTime'], event_time_column=df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_series_non_decreasing = IndividualColumnChecker.is_series_non_decreasing(df['MessageOutputTime'])
            is_series_epoch_valid = IndividualColumnChecker.is_series_epoch_valid(df['MessageOutputTime'])
            is_series_epoch_within_utc_z_day_range = IndividualColumnChecker.is_series_epoch_within_utc_z_day_range(df['MessageOutputTime'], date=asset_parameters.date, epoch_time_unit=epoch_time_unit)
            is_first_timestamp_within_60_s_from_the_utc_date_start = IndividualColumnChecker.is_first_timestamp_within_n_seconds_from_the_utc_date_start(df['MessageOutputTime'], date=asset_parameters.date, n_seconds=60, epoch_time_unit=epoch_time_unit)
            is_timestamp_of_receive_not_greater_than_message_output_time_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['TimestampOfReceive'], df['MessageOutputTime'], epoch_time_unit=epoch_time_unit)
            is_message_output_time_not_greater_than_timestamp_of_request_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['MessageOutputTime'], df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit)
            is_message_output_time_not_greater_than_transaction_time_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['MessageOutputTime'], df['TransactionTime'], epoch_time_unit=epoch_time_unit)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_series_non_decreasing = IndividualColumnChecker.is_series_non_decreasing(df['TransactionTime'])
            is_series_epoch_valid = IndividualColumnChecker.is_series_epoch_valid(df['TransactionTime'])
            is_series_epoch_within_utc_z_day_range = IndividualColumnChecker.is_series_epoch_within_utc_z_day_range(df['TransactionTime'], date=asset_parameters.date, epoch_time_unit=epoch_time_unit)
            is_first_timestamp_within_60_s_from_the_utc_date_start = IndividualColumnChecker.is_first_timestamp_within_n_seconds_from_the_utc_date_start(df['TransactionTime'], date=asset_parameters.date, n_seconds=60, epoch_time_unit=epoch_time_unit)
            is_timestamp_of_receive_not_greater_than_message_transaction_time_by_one_s_and_not_less_by_1_ms = (IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['TimestampOfReceive'], df['TransactionTime'], epoch_time_unit=epoch_time_unit))
            is_message_output_time_not_greater_than_transaction_time_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['MessageOutputTime'], df['TransactionTime'], epoch_time_unit=epoch_time_unit)
            is_transaction_time_not_greater_than_timestamp_of_request_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['TransactionTime'], df['TimestampOfRequest'], epoch_time_unit=epoch_time_unit)
            report.add_test_result("TransactionTime", "is_series_non_decreasing", is_series_non_decreasing)
            report.add_test_result("TransactionTime", "is_series_epoch_valid", is_series_epoch_valid)
        ...
        is_series_non_decreasing = IndividualColumnChecker.is_series_non_decreasing(df['LastUpdateId'])
        ...
        if asset_parameters.market == Market.COIN_M_FUTURES:
            is_there_only_one_unique_expected_value_in_series = IndividualColumnChecker.is_there_only_one_unique_expected_value_in_series(df['Pair'], asset_parameters.pairs[0].replace('_perp', '').upper())
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_each_snapshot_price_level_amount_accurate_to_1000 = IndividualColumnChecker.is_each_snapshot_price_level_amount_accurate_to_market(df[['LastUpdateId', 'IsAsk']], asset_parameters, expected_amount_of_price_levels_per_side=1000)
    ...
    def _get_full_trade_dataframe_report(df: pd.DataFrame, asset_parameters: AssetParameters) -> DataQualityReport:
        ...
        is_series_epoch_within_utc_z_day_range = IndividualColumnChecker.is_series_epoch_within_utc_z_day_range(df['TimestampOfReceive'], date=asset_parameters.date, epoch_time_unit=epoch_time_unit)
        is_timestamp_of_receive_not_greater_than_event_time_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['TimestampOfReceive'], df['EventTime'], epoch_time_unit=epoch_time_unit)
        is_timestamp_of_receive_not_greater_than_transaction_time_by_one_s_and_not_less_by_1_ms = IndividualColumnChecker.is_timestamp_of_column_a_not_greater_than_column_b_by_one_s_and_not_less_by_1_ms(df['TimestampOfReceive'], df['TransactionTime'], epoch_time_unit=epoch_time_unit)
        report.add_test_result("TimestampOfReceive", "is_series_non_decreasing", is_series_non_decreasing)
        report.add_test_result("TimestampOfReceive", "is_series_epoch_valid", is_series_epoch_valid)
        report.add_test_result("TimestampOfReceive", "is_series_epoch_within_utc_z_day_range", is_series_epoch_within_utc_z_day_range)
        report.add_test_result("TimestampOfReceive", "is_timestamp_of_receive_not_greater_than_event_time_by_one_s_and_not_less_by_1_ms", is_timestamp_of_receive_not_greater_than_event_time_by_one_s_and_not_less_by_1_ms)
        ...
        is_there_only_one_unique_expected_value_in_series = IndividualColumnChecker.is_there_only_one_unique_expected_value_in_series(df['Stream'], f"{asset_parameters.pairs[0]}@trade")
        report.add_test_result("Stream", "is_there_only_one_unique_expected_value_in_series", is_there_only_one_unique_expected_value_in_series)

        is_there_only_one_unique_expected_value_in_series = IndividualColumnChecker.is_there_only_one_unique_expected_value_in_series(df['EventType'], "trade")
        report.add_test_result("EventType", "is_there_only_one_unique_expected_value_in_series", is_there_only_one_unique_expected_value_in_series)
        ...
        are_series_values_increasing = IndividualColumnChecker.are_series_values_increasing(df['TradeId'])
        is_each_trade_id_bigger_by_one_than_previous = IndividualColumnChecker.is_each_series_value_bigger_by_one_than_previous(df['TradeId'])
        ...
        if asset_parameters.market == Market.SPOT:
            is_there_only_one_unique_expected_value_in_series = IndividualColumnChecker.is_there_only_one_unique_expected_value_in_series(df['MUnknownParameter'], True)
        ...
        if asset_parameters.market in [Market.USD_M_FUTURES, Market.COIN_M_FUTURES]:
            is_series_of_set_of_expected_values_market_insurance_fund_or_na = IndividualColumnChecker.is_series_of_set_of_expected_values(df['XUnknownParameter'], {"MARKET", "INSURANCE_FUND", 'NA', np.nan})
