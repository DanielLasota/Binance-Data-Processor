...
'''
    ...
    ::["_E"] 'TimestampOfReceive' [SPOT, USD_M_FUTURES, COIN_M_FUTURES]
            ...
            is_timestamp_of_receive_not_less_than_event_time_by_1_ms_and_not_greater_by_5000_ms                         (-1ms, +5s)
        [SPOT, USD_M_FUTURES]
        ...
        [USD_M_FUTURES, COIN_M_FUTURES]
            is_timestamp_of_receive_not_less_than_transaction_time_by_1_ms_and_not_greater_by_5000_ms                   (-1ms, +5s)
...
'''
    ...
    ::["_E"] 'TimestampOfReceive' [SPOT, USD_M_FUTURES, COIN_M_FUTURES]
            ...
            is_series_epoch_valid
            is_series_epoch_within_utc_z_day_range
            is_timestamp_of_receive_not_less_than_event_time_by_one_ms_and_not_greater_by_5000_ms                       (-1ms, +5s)
            is_timestamp_of_receive_not_less_than_transaction_time_by_one_ms_and_not_greater_by_5000_ms                 (-1ms, +5s)
