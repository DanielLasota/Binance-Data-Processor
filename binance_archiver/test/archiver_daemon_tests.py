...
import binance_archiver.difference_depth_queue
from binance_archiver.archiver_daemon import ArchiverDaemon, BadConfigException, \
...
class TestArchiverDaemon:
    ...
    class TestArchiverDaemonInit:
        ...
        def test_given_archiver_daemon_when_init_then_7_trade_queue_instances_exception_is_thrown(self):
            ...
            with pytest.raises(
                    binance_archiver.trade_queue.ClassInstancesAmountLimitException
            ) as excinfo:
        ...
        def test_given_archiver_daemon_when_init_then_7_difference_depth_queue_instances_is_exception_is_thrown(self):
            ...
            with pytest.raises(
                    binance_archiver.difference_depth_queue.ClassInstancesAmountLimitException
            ) as excinfo:
