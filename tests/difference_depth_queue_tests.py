...
class TestDifferenceDepthQueue:
    ...
    def test_given_too_many_difference_depth_queue_instances_exits_when_creating_new_then_exception_is_thrown(self):
        for _ in range(6):
    ...
    def test_given_putting_message_from_no_longer_accepted_stream_listener_id_when_try_to_put_then_method_returns_none(self):
        ...

    #

    def test_given_putting_message_when_adding_two_different_stream_listeners_message_throwsto_compare_structure_then_structure_is_ok(self):
        ...
    ...
    def test_given_putting_message_when_putting_message_of_currently_accepted_stream_id_then_message_is_being_added(self):
        ...
    ...
    def test_given_comparing_two_throws_when_throws_are_equal_then_method_returns_true(self):
        ...
        print(f'old_stream_listener_id {old_stream_listener_id.pairs_amount}')
        print(f'new_stream_listener_id {new_stream_listener_id.pairs_amount}')
